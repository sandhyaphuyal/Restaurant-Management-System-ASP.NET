...
namespace WebApplication16.Controllers
{
    ...
    {
        // GET: Staff
        MyProjectEntities DbbModel = new MyProjectEntities();
        public ActionResult Index()
        {
            return View(DbbModel.Table_2.ToList());
        }
        // GET: Customer/Details/5
        public ActionResult Details(int id)
        {
            return View(DbbModel.Table_2.Where(x => x.STAFF_ID == id).FirstOrDefault());
        ...
        [HttpPost]
        public ActionResult Create(Table_2 table_2, HttpPostedFileBase UploadedFile)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    DbbModel.Table_2.Add(table_2);
                    DbbModel.SaveChanges();
        ...
        [HttpPost]
        public ActionResult Edit(int id, Table_2 table_2, HttpPostedFileBase UploadedFile)
        {
            try
            {
                // TODO: Add update logic here
                DbbModel.Entry(table_2).State = EntityState.Modified;
                DbbModel.SaveChanges();
                return RedirectToAction("Index");
        ...
        {
            return View(DbbModel.Table_2.Find(id));
        }
        ...
        public ActionResult Delete(int id, FormCollection collection)
        {
            try
            {
                ...
                Table_2 table_2 = DbbModel.Table_2.Find(id);
                DbbModel.Table_2.Remove(table_2);
                DbbModel.SaveChanges();
